  ...
  return (
    <details ref={ref} className="group relative">
      ...
      <div className={inline
        ...
        : 'fixed left-2 right-2 top-14 z-50 max-h-[calc(100vh-72px)] overflow-y-auto rounded-xl border border-zinc-200 bg-zinc-50 shadow-lg dark:border-zinc-800 dark:bg-zinc-950 sm:absolute sm:left-0 sm:right-auto sm:top-full sm:mt-2 sm:max-h-[calc(100vh-100px)] sm:w-80'
      }>
        <div className="p-5">
